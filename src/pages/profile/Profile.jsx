    ...
    return (
        <main>
            <div className='block profile'>
                ...
                <Font.Title>Seu Perfil</Font.Title>
                ...
                <form onSubmit={(e) => {e.preventDefault();}}>
                    ...
                    <div className='input-block'>
                        ...
                        <Input
                            type="email"
                            value={state.email} onChange={(e) => dispatch({type:'emailChange', payload:{value:e.target.value}})}
                        />
                    </div>
                        ...
                        <section role="edit card" id="editCard">
                            ...
                            <div className='input-block'>
                                ...
                                <Input
                                    type="text"
                                    value={card.id}
                                    onChange={(e) => {setCard(p => ({...p, id:e.target.value}))}}
                                />
                            </div>
                            ...
                            <Button.Submit
                                onClick={() => {dispatch({type:'add_card',payload:{card}})}}
                            >
                                <i className='fa-solid fa-plus'></i>
                                Adicionar Cartão (rascunho)
                            </Button.Submit>
                            <Button.Submit
                                onClick={() => {dispatch({type:'change_card',payload:{card}})}}
                            >
                                <i class="fa-solid fa-plus"></i>
                                Alterar Cartão (rascunho)
                            </Button.Submit>
                        </section>
                        <ul>
